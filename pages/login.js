                        ...
                        <div className="card-body" style={{backgroundColor:'white'}}>
                            ...
                            <form style={{margin:'20px auto', width:'400px'}}>
                                <div className="form-group">
                                    ...
                                    <input type="email" className="form-control" onBlur={(e)=>{this.checkFormValidation('email',e)}} onChange={(e)=>{this.setState({email:e.target.value})}} placeholder="Enter email"/>
